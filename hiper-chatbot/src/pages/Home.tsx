        ...
        <div className="landing-header-left">
          <div className="landing-logo-emblem">
            <svg viewBox="0 0 100 100" width="30" height="30" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M 39 38 Q 50 31 61 38" stroke="#ffffff" stroke-width="8" fill="none" stroke-linecap="round" />
              <path d="M 39 58 Q 50 65 61 58" stroke="#ffffff" stroke-width="8" fill="none" stroke-linecap="round" />
            </svg>
          </div>
      ...
      <main className="landing-body">
        <div className="large-logo-container">
          <svg viewBox="0 0 300 180" width="300" height="180" xmlns="http://www.w3.org/2000/svg">
            <path d="M 75 110 A 75 75 0 0 1 225 110 Z" fill="#e05206" stroke="#003b6f" stroke-width="8" />
            
            <g transform="translate(0, 8)">
              <rect x="134" y="56" width="9" height="42" rx="4.5" fill="#ffffff" />
              <rect x="157" y="56" width="9" height="42" rx="4.5" fill="#ffffff" />
              <path d="M 143 70 Q 150 64 157 70" stroke="#ffffff" stroke-width="4.5" fill="none" stroke-linecap="round" />
              <path d="M 143 82 Q 150 88 157 82" stroke="#ffffff" stroke-width="4.5" fill="none" stroke-linecap="round" />
            </g>
            
            <rect x="20" y="102" width="260" height="56" rx="6" fill="#e05206" stroke="#003b6f" stroke-width="8" />
            
            <text 
              x="150" 
              y="144" 
              font-family="'Outfit', 'Outfit-Bold', sans-serif" 
              font-weight="900" 
              font-size="32" 
              fill="#ffffff" 
              text-anchor="middle" 
              ...
              <div className="col-illustration-container">
                <svg viewBox="0 0 160 120" width="160" height="120" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <g transform="translate(15, 10)">
                    ...
                    <path d="M 29 39 Q 32 41 35 39" stroke="#1e293b" stroke-width="1.5" fill="none" />
                  ...
                  <g transform="translate(80, 10)">
                    ...
                    <rect x="24" y="30" width="7" height="5" rx="1" fill="none" stroke="#1e293b" stroke-width="1.5" />
                    <rect x="33" y="30" width="7" height="5" rx="1" fill="none" stroke="#1e293b" stroke-width="1.5" />
                    <line x1="31" y1="33" x2="33" y2="33" stroke="#1e293b" stroke-width="1.5" />
                    <path d="M 29 39 Q 32 41 35 39" stroke="#1e293b" stroke-width="1.5" fill="none" />
                  ...
                  <g transform="translate(68, 66)">
                    <path d="M -15 -1 L 5 -1 M -15 2 L 5 2" stroke="#ffffff" stroke-width="5" stroke-linecap="round" />
                    <path d="M 30 -1 L 10 -1 M 30 2 L 10 2" stroke="#ffffff" stroke-width="5" stroke-linecap="round" />
                    <circle cx="7" cy="0" r="5.5" fill="#fed7aa" />
                    <circle cx="12" cy="0" r="5.5" fill="#fed7aa" />
                    <path d="M 4 -4 Q 9 1 14 -4" stroke="#2c3e50" stroke-width="1.5" fill="none" />
                  </g>
                </svg>
              </div>
            ...
            <div className="portal-grid-col">
              <div className="col-illustration-container">
                <svg viewBox="0 0 160 120" width="160" height="120" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect x="92" y="24" width="38" height="48" rx="2.5" fill="#ffffff" stroke="#cbd5e1" stroke-width="1.5" transform="rotate(8, 111, 48)" />
                  <rect x="92" y="24" width="38" height="10" fill="#ef4444" transform="rotate(8, 111, 48)" />
                  <line x1="97" y1="42" x2="117" y2="45" stroke="#94a3b8" stroke-width="2" transform="rotate(8, 111, 48)" />
                  <line x1="97" y1="49" x2="124" y2="53" stroke="#94a3b8" stroke-width="2" transform="rotate(8, 111, 48)" />
                  <line x1="97" y1="56" x2="120" y2="59" stroke="#94a3b8" stroke-width="2" transform="rotate(8, 111, 48)" />
                  ...
                  <g transform="translate(18, 22) rotate(-12)">
                    ...
                    <line x1="17" y1="14" x2="17" y2="48" stroke="#ea580c" stroke-width="1.5" />
                    <line x1="35" y1="14" x2="35" y2="48" stroke="#ea580c" stroke-width="1.5" />
                    <path d="M 19 14 C 19 26, 25 30, 25 30 C 25 30, 31 26, 31 14 Z" fill="#f1f5f9" stroke="#475569" stroke-width="1.2" />
                    <path d="M 19 48 C 19 36, 25 30, 25 30 C 25 30, 31 36, 31 48 Z" fill="#f1f5f9" stroke="#475569" stroke-width="1.2" />
                    ...
                    <line x1="26" y1="28" x2="26" y2="38" stroke="#f59e0b" stroke-width="1.2" stroke-dasharray="1.5,1.5" />
                  </g>

                  {/* Clock / Pie Chart bottom left */}
                  <circle cx="34" cy="84" r="16" fill="#ffffff" stroke="#475569" stroke-width="1.8" />
                  <path d="M 34 84 L 34 68 A 16 16 0 0 1 50 84 Z" fill="#3b82f6" />
                  <line x1="34" y1="84" x2="43" y2="84" stroke="#475569" stroke-width="1.8" stroke-linecap="round" />
                  <line x1="34" y1="84" x2="34" y2="73" stroke="#475569" stroke-width="1.8" stroke-linecap="round" />
